 ...
 */
public class GoogleAnalyticUsersNodePlugin extends Plugin {
    // The shared instance.
    private static GoogleAnalyticUsersNodePlugin plugin;

    /**
     * The constructor.
     */
    public GoogleAnalyticUsersNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static GoogleAnalyticUsersNodePlugin getDefault() {
        return plugin;
    }
